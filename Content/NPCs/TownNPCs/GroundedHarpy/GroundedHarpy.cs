    ...
    public override string GetChat()
    {
        ...
        else
        {
            ...
            if (BirthdayParty.PartyIsUp)
            {
                ...
                if (partyGirl >= 0)
                    chat.Add(Language.GetTextValue("Mods.WgMod.Dialogue.GroundedHarpy.PartyDialogue2", Main.npc[partyGirl].GivenName), 2); // "Please tell {1} not to pin the tail on the harpy!"
            }
