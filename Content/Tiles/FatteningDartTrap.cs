...
public class FatteningDartTrap : ModTile
{
    ...
    public override void HitWire(int i, int j)
    {
        ...
        if (Wiring.CheckMech(i, j, 198))
        {
            ...
            Projectile.NewProjectile(Wiring.GetProjectileSource(i, j), spawnPosition, new Vector2(horizontalDirection, verticalDirection) * 12f, ModContent.ProjectileType<FatteningDart>(), 20, 2f, Main.myPlayer);
        }
    }
}
